...
function SupportScreen:init( owner, locked )
    ...
    self.subtitle = self.content:AddChild( Widget.Label("title", FONT_SIZE.BODY_TEXT ) )
        :SetText( "To get elected, you need to have high support among the people. Your advisor has compiled the support breakdown for your campaign. Use this to carefully plan your campaign." )
        :SetGlyphColour( UICOLOURS.GRAFT )
        :SetAutoSize(DETAILS_W)
        :LeftAlign()
        :SetWordWrap(true)
