local QDEF = QuestDef.Define
{
    ...
    on_complete = function(quest)
        ...
        elseif quest.param.sub_optimal then
            ...
            DemocracyUtil.TryMainQuestFn("DeltaWealthSupport", 4, 2, "COMPLETED_QUEST_REQUEST")
        elseif quest.param.poor_performance then
            DemocracyUtil.TryMainQuestFn("DeltaWealthSupport", 5, 1, "COMPLETED_QUEST_REQUEST")
