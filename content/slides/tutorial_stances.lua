...
For each group, each <#BONUS>+</> indicates one support gain among that group when you pick that stance, and each <#PENALTY>-</> indicates one support loss among that group when you pick that stance.]]
        },
...
If you "favor" a stance, taking another stance that is on the same side of the issue will count as consistent stance, meaning you will gain general support instead of losing some. The same is true if you have already taken a stance, and you favor another stance on the same side.]]
        },

        {
            img = 'DEMOCRATICRACE:assets/slides/tutorials/stances_4.png',
            txt = [[<b>Favoring Stances (Continued):</>
